...
label(minipage("\textit{奇怪的鞍点}", 1.2cm), (5, 0));

label("\underline{局部极小}", (1, 1.2), dir(90));
label("\underline{局部极大}", (2, 1.2), dir(90));
label("\underline{鞍点}", (3, 1.2), dir(90));
label("\underline{鞍点}", (4, 1.2), dir(90));
