...
label("点 $(u,v)$ 在 $\mathcal{R}$ 中", Pl, dir(Pl-P), brown);
label("点 $\mathbf{r}(u,v)$ 在 $\mathcal{S}$ 中", Ql, dir(Ql-Q), deepgreen);
...
label("点对 $(u,v)$ 在区域 $\mathcal{R}$ 中", (13, 8));
label("(一张纸)", (13, 7));

label("曲面 $\mathcal{S}$", (13, 2));
label("(位于空间 $\mathbb{R}^3$ 中)", (13, 1));
